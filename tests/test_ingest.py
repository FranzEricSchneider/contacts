...
class TestIngest(unittest.TestCase):
    ...
    def test_parse_text_file(self):
        ...
        try:
            ...
            self.assertEqual(contacts[0].data_lines[("address", "2024-01-01: 123 Main St")], 3)
            ...
            self.assertEqual(contacts[1].data_lines[("address", "2024-01-02: 456 Oak Ave")], 11)
    ...
    def test_update_contacts(self):
        ...
        try:
            ...
            contacts = {
                c.name: c
                for c in load_contacts(yaml_file)
            }
    ...
    def test_validate_similar_names(self):
        ...
        try:
            ...
            self.assertIn("similar to existing contact 'John Doe'", error_msg)
            self.assertIn("'Jane Smyth' in", error_msg)
            self.assertIn("similar to existing contact 'Jane Smith'", error_msg)
